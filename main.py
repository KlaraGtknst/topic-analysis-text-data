...
from text_embeddings.InferSent import infer_pretrained, own_word2vec
...
if __name__ == '__main__':
    ...
    # test
        ...
        # python3 main.py 'own_word2vec.py' -d '/Users/klara/Documents/Uni/bachelorarbeit/data/0/*.pdf'
