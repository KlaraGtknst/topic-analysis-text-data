...
srun python /mnt/stud/work/kgutekunst/topic-analysis-text-data/main_server.py 'convert_pdf2image.py' -d '/mnt/datasets/Bahamas' -o '/mnt/stud/home/kgutekunst/visualizations/pdf2png/'  # Programm ausfuehren
