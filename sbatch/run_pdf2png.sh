...
srun python /mnt/stud/work/kgutekunst/topic-analysis-text-data/convert_pdf2image.py -d '/mnt/datasets/Bahamas/SAC/0/*.pdf' -o '/mnt/stud/home/kgutekunst/visualizations/images/' --cluster True    # Programm ausfuehren