...
srun python /mnt/stud/work/kgutekunst/topic-analysis-text-data/main_server.py 'db_elasticsearch.py' -d '/mnt/datasets/Bahamas/SAC/0/*.pdf' -o '/mnt/stud/home/kgutekunst/visualizations/images/'  # Programm ausfuehren
