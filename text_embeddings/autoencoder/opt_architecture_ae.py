...
def main(src_path, num_cpus:int):
    ...
    # [2048, 3072, 4096] 3
    # 4
    # [2048, 3412, 2730, 4096] 4
    # 5
    # [2048, 3584, 3072, 2560, 4096] 5
    # 6
    # [2048, 3684, 3275, 2866, 2457, 4096] 6
    # 7
    # [2048, 3753, 3412, 3071, 2730, 2389, 4096] 7
    # 8
    # [2048, 3800, 3508, 3216, 2924, 2632, 2340, 4096] 8
    # 9
    # [2048, 3840, 3584, 3328, 3072, 2816, 2560, 2304, 4096] 9
    # 10
    # [2048, 3864, 3637, 3410, 3183, 2956, 2729, 2502, 2275, 4096] 10
